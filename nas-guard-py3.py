...
BAND = '''
 ...
 |_| \_/_/    \_\_____/      \_____|\____/_/    \_\_|  \_\_____/ cheneyjin@outlook.com

 [NAS_GUARD]: shutdown/hibernate device where your router can not find in times.
'''
...
if __name__ == '__main__':
    ...
    if params is not None:
        ...
        # !!! 不要取消这句SLEEP，否则设置开机启动后，电脑将陷入永久的开关机循环中。恢复起来很麻烦!!!
